...
InputPath=os.path.abspath(os.path.join(parent_path, 'Input'))
ResultPath=os.path.abspath(os.path.join(parent_path, 'output','result.txt'))
        ...
        for node_id in top_k:
            ...
            if score == 1:
                with open(ResultPath, "a") as f:
                    f.write("얼굴형 : " + label_lines[node_id])
                    print("저장되었습니다.")
...
model_dir =os.path.abspath(os.path.join(current_path, 'result')) #'''mydirpath +''' 
imagedir =InputPath
#input" #'''mydirpath +'''
